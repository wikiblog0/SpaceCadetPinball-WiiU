...
const TextArray translations::Translations =
{
	...
	},
	{
		Msg::STRING123,
		{
			...
			{ Lang::Czech, "Hra pozastavena. Pokračujte klávesou +." },
	...
	},
	{
		Msg::STRING125,
		{
			{ Lang::Arabic, "- Starts New Game" },
			{ Lang::Czech, "Stisknutím klávesy - zahájíte novou hru." },
			{ Lang::Danish, "- starter nyt spil" },
			{ Lang::German, "-: Neues Spiel starten" },
			{ Lang::Greek, "- για να ξεκινήσετε μια νέα παρτίδα" },
			{ Lang::English, "- Starts New Game" },
			{ Lang::Spanish, "- inicia un nuevo juego" },
			{ Lang::Finnish, "-: Uusi peli" },
			{ Lang::French, "- Nouvelle partie" },
			{ Lang::Hebrew, "- Starts New Game" },
			{ Lang::Hungarian, "- új játékot kezd" },
			{ Lang::Italian, "- per iniziare una nuova partita" },
			{ Lang::Japanese, "- キーで新ゲーム開始" },
			{ Lang::Korean, "<-> 키로 새 게임 시작" },
			{ Lang::Norwegian, "- starter et nytt spill" },
			{ Lang::Dutch, "- start een nieuw spel" },
			{ Lang::Polish, "- rozpoczyna nową grę." },
			{ Lang::BrazilianPortuguese, "- começa um novo jogo" },
			{ Lang::Portuguese, "- inicia um novo jogo" },
			{ Lang::Russian, "Нажмите -, чтобы начать новую игру" },
			{ Lang::Swedish, "-=Nytt spel" },
			{ Lang::Turkish, "- Yeni Oyun Başlatır" },
			{ Lang::SimplifiedChinese, "- 开局" },
			{ Lang::TraditionalChinese, "- 開始新遊戲" },
		},
	},
	{
		Msg::STRING126,
